...
#include "../../SettingManager/aboutdialog.h"
...
struct qt_meta_stringdata_cAboutDialog_t {
    QByteArrayData data[3];
    char stringdata[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cAboutDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cAboutDialog_t qt_meta_stringdata_cAboutDialog = {
    {
QT_MOC_LITERAL(0, 0, 12),
QT_MOC_LITERAL(1, 13, 28),
QT_MOC_LITERAL(2, 42, 0)
    },
    "cAboutDialog\0on_commandLinkButton_clicked\0"
    ""
};
...
const QMetaObject cAboutDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_cAboutDialog.data,
      qt_meta_data_cAboutDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cAboutDialog.stringdata))
